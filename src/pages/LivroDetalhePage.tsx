...
import { ArrowLeft, BookOpen, Download, Loader2, Coins, FileText, Eye, Share2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 pb-24 md:pb-6">
        <div className="flex flex-col md:flex-row gap-6 lg:gap-8">
          ...
          {/* Top Section: Capa e Info Básica (Lado a Lado no Mobile) */}
          <div className="flex flex-row md:flex-col gap-4 sm:gap-6 md:w-[280px] lg:w-[320px] flex-shrink-0">
            ...
            <div className="w-[120px] sm:w-[160px] md:w-full flex-shrink-0">
              <div className="bg-secondary rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden aspect-[2/3] shadow-md md:shadow-lg">
                {book.capa_url ? (
                  <img 
                    src={book.capa_url} 
                    alt={book.titulo} 
            ...
            <div className="flex-1 flex flex-col justify-center md:hidden space-y-2">
              ...
              <h1 className="text-base sm:text-lg font-bold tracking-tight leading-tight line-clamp-3">
                {book.titulo}
              </h1>
              <p className="text-[11px] sm:text-xs text-muted-foreground">por <span className="font-semibold text-foreground">{book.autor}</span></p>
          ...
          {/* Bottom/Right Section: Descrição e Ações */}
          <div className="flex-1 space-y-6">
            
            {/* Info Básica apenas para Desktop (escondida no mobile pois já aparece ao lado da capa) */}
            ...
            {/* Descrição - Aparece abaixo da seção superior no mobile */}
            <div className="space-y-2">
              <h3 className="text-sm font-semibold md:hidden">Sobre o livro</h3>
              <Card className="border-dashed">
                <CardContent className="p-3 sm:p-4 text-xs sm:text-sm leading-relaxed whitespace-pre-wrap text-foreground/90">
                  {book.descricao || "Sem descrição disponível."}
                </CardContent>
              </Card>
            </div>

            {/* Botões de Ação - Sempre abaixo no Mobile */}
            ...
            <div className="pt-4 border-t border-border flex justify-between text-[10px] sm:text-xs text-muted-foreground">
              ...
              <span className="md:hidden">{book.downloads} downloads</span>
            </div>
          </div>
        </div>
      </div>
